        ...
        <div className="flex w-[325px] md:w-[800px] justify-center mx-auto  ">
            <article className="prose text-md  lg:prose-lg">
              ...
              <p>
                ...
                <p className = "dark:text-rose-500">
                    Best Regards,
                </p>
                {/* <span className = "font-semibold font-mono">Bibhabendu Mukherjee</span> */}
                <blockquote className='border-l-[#F7AB0A] dark:text-rose-500/80  text-lg border-l-4 pl-5 py-2 my-5 '>Bibhabendu Mukherjee</blockquote>
            </article>
        </div>
    )
}